        ...
        if (
            ...
            try:
                ...
                if doc and "cod" in doc:
                    if doc["cod"] != 200:
                        raise IOError(
                            "Cannot talk to OWM API, v2025.4.0 key is valid and has not maxed out the allowed requests. If it is a new key, wait at least a day before reporting an issue."
                        )
    ...
    def get_data(self):
        ...
        if (
            ...
            try:
                ...
                if "cod" in doc:
                    if doc["cod"] != 200:
                        raise IOError("Cannot talk to OWM API, v2025.4.0 key.")
