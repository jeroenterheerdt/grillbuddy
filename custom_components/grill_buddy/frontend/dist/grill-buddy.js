!(function (e) {
      ...
      : (e) =>
          e instanceof CSSStyleSheet
            ? ((e) => {
                ...
                return ((e) =>
                  new u("string" == typeof e ? e : e + "", void 0, l))(t);
              })(e)
            : e;
  /**
   * @license
  ...
  (A[E] = !0),
    ...
    null == g || g({ ReactiveElement: A }),
    (null !== (d = m.reactiveElementVersions) && void 0 !== d
      ? d
      : (m.reactiveElementVersions = [])
    ).push("1.6.3");
  const H = window,
    $ = H.trustedTypes,
    T = $ ? $.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
    S = "$lit$",
    ...
    z = new WeakMap(),
    X = O.createTreeWalker(O, 129, null, !1);
  function W(e, t) {
  ...
  const Z = (e, t) => {
    ...
    for (let t = 0; t < r; t++) {
      ...
      let a,
        ...
        h = -1,
        u = 0;
      for (; u < r.length && ((o.lastIndex = u), (l = o.exec(r)), null !== l); )
        (u = o.lastIndex),
          o === x
            ? "!--" === l[1]
              ? (o = M)
              ...
              ? ">" === l[0]
                ...
                : void 0 === l[1]
                  ...
                  : ((h = o.lastIndex - l[2].length),
                    (a = l[1]),
                    (o = void 0 === l[3] ? k : '"' === l[3] ? D : G))
              : o === D || o === G
                ? (o = k)
                : o === M || o === U
                  ? (o = x)
                  : ((o = k), (s = void 0));
      const c = o === k && e[t + 1].startsWith("/>") ? " " : "";
      n +=
        o === x
          ? r + L
          : h >= 0
            ? (i.push(a), r.slice(0, h) + S + r.slice(h) + B + c)
            : r + B + (-2 === h ? (i.push(void 0), t) : c);
    }
        ...
        if (1 === i.nodeType) {
          if (i.hasAttributes()) {
            ...
            for (const t of i.getAttributeNames())
              if (t.endsWith(S) || t.startsWith(B)) {
                const r = h[n++];
    ...
    return (
      (null == l ? void 0 : l.constructor) !== h &&
        (null === (n = null == l ? void 0 : l._$AO) ||
          void 0 === n ||
          n.call(l, !1),
        void 0 === h ? (l = void 0) : ((l = new h(e)), l._$AT(e, r, i)),
        void 0 !== i
  ...
  class J {
    ...
    _(e) {
      this._$AH !== K && N(this._$AH)
        ? (this._$AA.nextSibling.data = e)
        : this.$(O.createTextNode(e)),
        (this._$AH = e);
    }
    g(e) {
      var t;
    ...
    _$AC(e) {
      ...
      return void 0 === t && z.set(e.strings, (t = new Y(e))), t;
    }
    T(e) {
      ...
      for (const s of e)
        i === t.length
          ? t.push((r = new J(this.k(C()), this.k(C()), this, this.options)))
          : (r = t[i]),
          r._$AI(s),
          i++;
  ...
  class se extends ee {
    ...
    _$AI(e, t = this) {
      var r;
      if ((e = null !== (r = q(this, e, t, 0)) && void 0 !== r ? r : K) === V)
        return;
      const i = this._$AH,
        s =
          (e === K && i !== K) ||
  ...
  null == oe || oe(Y, J),
    (null !== (w = H.litHtmlVersions) && void 0 !== w
      ? w
      : (H.litHtmlVersions = [])
    ).push("2.8.0");
  /**
  ...
  (he.finalized = !0),
    ...
    null === (ae = globalThis.litElementHydrateSupport) ||
      void 0 === ae ||
      ae.call(globalThis, { LitElement: he });
  const ue = globalThis.litElementPolyfillSupport;
  null == ue || ue({ LitElement: he }),
  ...
  const ye = async () => {
    ...
    He = "probe_preset",
    $e = "probe_lower_bound",
    Te = "probe_upper_bound",
    Se = "probe_state_update_setting",
    Be = "probe_source_type",
    Pe = "source_type_preset",
    Le = "probe_target_temperature",
    Oe = "metric",
    Ce = (e) => e.callWS({ type: Ee + "/config" }),
    Ne = (e) => {
      class t extends e {
        connectedCallback() {
      ...
      return s([me({ attribute: !1 })], t.prototype, "hass", void 0), t;
    };
  function Ie(e, t) {
    !(function (e, t) {
      const r = e;
...
`;
  let Me = class extends Ne(he) {
    ...
    async _fetchData() {
      this.hass &&
        ((this.config = await Ce(this.hass)), (this.data = this.config));
    }
    firstUpdated() {
      (async () => {
        await ye();
  ...
  s([me()], Me.prototype, "narrow", void 0),
    s([me()], Me.prototype, "path", void 0),
    s([me()], Me.prototype, "data", void 0),
    s([me()], Me.prototype, "config", void 0),
    (Me = s([ce("grill-buddy-view-general")], Me));
  /**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   ...
   */ class Ge extends ke {
    constructor(e) {
      if ((super(e), (this.et = K), e.type !== Ue))
        throw Error(
    ...
    render(e) {
      if (e === K || null == e) return (this.ft = void 0), (this.et = e);
      if (e === V) return e;
      if ("string" != typeof e)
        throw Error(
  ...
  var je,
    Fe,
    Ve,
    Ke = { actions: { delete: "Delete" }, labels: { select: "Select" } },
    ze = {
      probes: {
        title: "Probes",
    ...
    Qe = { actions: { delete: "Verwijderen" }, labels: { select: "Kies" } },
    Je = {
      probes: {
        title: "Thermometers",
        ...
        errors: {
          ...
          source_does_not_exist:
            "De bron bestaat niet. Vul een bestaande bron in, zoals bijvoorbeeld 'sensor.mysensor'.",
        },
        cards: {
          "add-probe": {
    ...
    nt = { actions: { delete: "Löschen" }, labels: { select: "Auswählen" } },
    ot = {
      probes: {
        title: "Fühler",
        ...
        errors: {
          ...
          source_does_not_exist:
            "Quelle existiert nicht. Bitte gib eine gültige Quelle ein, z. B. 'sensor.mysensor'.",
        },
        cards: {
          "add-probe": {
      ...
      help: {
        ...
        cards: {
          "how-to-get-help": {
            ...
            readme: "Readme",
            "if-you-still-need-help":
              "Wenn du weiterhin Hilfe brauchst, kontaktiere das",
            "community-forum": "Community-Forum",
    ...
    for (var t = {}, r = 0, s = e; r < s.length; r++) {
      ...
      switch (n.stem) {
        ...
        case "integer-width":
          ...
          n.options[0].replace(Pt, function (e, r, i, s, n, o) {
      ...
      if (Lt.test(n.stem)) t.minimumIntegerDigits = n.stem.length;
      else if (St.test(n.stem)) {
        if (n.options.length > 1)
          throw new RangeError(
            "Fraction-precision stems only accept a single optional option"
          );
        n.stem.replace(St, function (e, r, i, s, n, o) {
          return (
            "*" === i
        ...
        "w" === o
          ...
          : o && (t = i(i({}, t), Ot(o)));
      } else if (Bt.test(n.stem)) t = i(i({}, t), Ot(n.stem));
      else {
        var a = Ct(n.stem);
        a && (t = i(i({}, t), a));
        var l = Nt(n.stem);
  ...
  function Ut(e) {
    ...
    return (
      ...
      (Mt[r || ""] || Mt[i || ""] || Mt["".concat(i, "-001")] || Mt["001"])[0]
    );
  }
  var kt = new RegExp("^".concat(wt.source, "*")),
    Gt = new RegExp("".concat(wt.source, "*$"));
  function Dt(e, t) {
    return { start: e, end: t };
  }
  var jt = !!String.prototype.startsWith && "_a".startsWith("a", 1),
    Ft = !!String.fromCodePoint,
    Vt = !!Object.fromEntries,
    Kt = !!String.prototype.codePointAt,
    zt = !!String.prototype.trimStart,
  ...
  try {
    Zt =
      "a" ===
      (null ===
        (xt = ir("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec(
          "a"
        )) || void 0 === xt
        ? void 0
        : xt[0]);
  ...
  if (Zt) {
    var sr = ir("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
    Yt = function (e, t) {
      var r;
      return (
        (sr.lastIndex = t),
        null !== (r = sr.exec(e)[1]) && void 0 !== r ? r : ""
      );
    };
  } else
    Yt = function (e, t) {
  ...
  var nr = (function () {
    ...
    return (
            ...
            if (35 !== s || ("plural" !== t && "selectordinal" !== t)) {
              if (60 === s && !this.ignoreTag && 47 === this.peek()) {
                ...
                return this.error(
                  ...
                  Dt(this.clonePosition(), this.clonePosition())
                );
              }
              ...
              this.bump(),
                i.push({
                  type: Fe.pound,
                  location: Dt(o, this.clonePosition()),
                });
            }
          }
        }
        ...
        if ((this.bumpSpace(), this.bumpIf("/>")))
          return {
            val: {
              type: Fe.literal,
              value: "<".concat(i, "/>"),
              location: Dt(r, this.clonePosition()),
            },
            err: null,
          };
        if (this.bumpIf(">")) {
          ...
          if (this.bumpIf("</")) {
            if (this.isEOF() || !or(this.char()))
              return this.error(je.INVALID_TAG, Dt(o, this.clonePosition()));
            var a = this.clonePosition();
            return i !== this.parseTagName()
              ? this.error(
                  je.UNMATCHED_CLOSING_TAG,
                  Dt(a, this.clonePosition())
                )
              : (this.bumpSpace(),
                this.bumpIf(">")
                  ? {
                  ...
                  : this.error(je.INVALID_TAG, Dt(o, this.clonePosition())));
          }
          return this.error(je.UNCLOSED_TAG, Dt(r, this.clonePosition()));
        }
        return this.error(je.INVALID_TAG, Dt(r, this.clonePosition()));
      }),
      (e.prototype.parseTagName = function () {
        var e = this.offset();
        for (this.bump(); !this.isEOF() && ar(this.char()); ) this.bump();
      ...
      (e.prototype.parseLiteral = function (e, t) {
        ...
        var a = Dt(r, this.clonePosition());
        return { val: { type: Fe.literal, value: i, location: a }, err: null };
      }),
      (e.prototype.tryParseLeftAngleBracket = function () {
        return this.isEOF() ||
          60 !== this.char() ||
          (!this.ignoreTag && (or((e = this.peek() || 0)) || 47 === e))
          ? null
          : (this.bump(), "<");
        var e;
      }),
      ...
      (e.prototype.parseArgument = function (e, t) {
        ...
        if ((this.bump(), this.bumpSpace(), this.isEOF()))
          return this.error(
            ...
            Dt(r, this.clonePosition())
          );
        if (125 === this.char())
          return (
            this.bump(),
            this.error(je.EMPTY_ARGUMENT, Dt(r, this.clonePosition()))
          );
        var i = this.parseIdentifierIfPossible().value;
        if (!i)
          return this.error(je.MALFORMED_ARGUMENT, Dt(r, this.clonePosition()));
      ...
      (e.prototype.parseIdentifierIfPossible = function () {
        var e = this.clonePosition(),
          ...
          i = t + r.length;
        return (
          this.bumpTo(i), { value: r, location: Dt(e, this.clonePosition()) }
        );
      }),
      (e.prototype.parseArgumentOptions = function (e, t, r, s) {
        ...
        switch (a) {
          case "":
            return this.error(je.EXPECT_ARGUMENT_TYPE, Dt(o, l));
          case "number":
          case "date":
          case "time":
            this.bumpSpace();
            ...
            if (this.bumpIf(",")) {
              ...
              if (0 === (m = rr(_.val)).length)
                return this.error(
                  je.EXPECT_ARGUMENT_STYLE,
                  Dt(this.clonePosition(), this.clonePosition())
                );
              h = { style: m, styleLocation: Dt(u, this.clonePosition()) };
            }
            if ((v = this.tryParseArgumentClose(s)).err) return v;
            var c = Dt(s, this.clonePosition());
            if (h && qt(null == h ? void 0 : h.style, "::", 0)) {
              var p = tr(h.style.slice(2));
              if ("number" === a)
              ...
              if (0 === p.length)
                return this.error(je.EXPECT_DATE_TIME_SKELETON, c);
              var d = p;
              this.locale &&
                (d = (function (e, t) {
            ...
            return {
              val: {
                ...
                location: c,
                style:
                  null !== (n = null == h ? void 0 : h.style) && void 0 !== n
                    ? n
                    : null,
              },
              err: null,
          ...
          default:
            return this.error(je.INVALID_ARGUMENT_TYPE, Dt(o, l));
        }
      }),
      ...
      (e.prototype.parseNumberSkeletonFromString = function (e, t) {
        ...
        try {
          r = (function (e) {
            ...
            for (
              var t = e.split(Tt).filter(function (e) {
                  return e.length > 0;
                }),
                r = [],
                i = 0,
      ...
      (e.prototype.tryParsePluralOrSelectOptions = function (e, t, r, i) {
        for (
          var s, n = !1, o = [], a = new Set(), l = i.value, h = i.location;
          ;
          ...
          if (m.err) return m;
          o.push([l, { value: d.val, location: Dt(p, this.clonePosition()) }]),
            a.add(l),
            this.bumpSpace(),
  ...
  function ur(e) {
    e.forEach(function (e) {
      if ((delete e.location, gt(e) || _t(e)))
        for (var t in e.options)
          delete e.options[t].location, ur(e.options[t].value);
      else
        (mt(e) && Et(e.style)) || ((ft(e) || bt(e)) && At(e.style))
  ...
  function cr(e, t) {
    ...
    return (null == t ? void 0 : t.captureLocation) || ur(r.val), r.val;
  }
  function pr(e, t) {
    var r = t && t.cache ? t.cache : yr,
      i = t && t.serializer ? t.serializer : gr;
    return (t && t.strategy ? t.strategy : br)(e, { cache: r, serializer: i });
  }
  function dr(e, t, r, i) {
    var s,
      n =
  ...
  var vr,
    ...
    Er = {
      variadic: function (e, t) {
        return fr(e, this, mr, t.cache.create(), t.serializer);
      },
  ...
  function Br(e, t, r, i, s, n, o) {
    if (1 === e.length && pt(e[0]))
      return [{ type: Ar.literal, value: e[0].value }];
    for (var a = [], l = 0, h = e; l < h.length; l++) {
      var u = h[l];
      if (pt(u)) a.push({ type: Ar.literal, value: u.value });
      else if (vt(u))
        "number" == typeof n &&
          a.push({ type: Ar.literal, value: r.getNumberFormat(t).format(n) });
      else {
        var c = u.value;
        if (!s || !(c in s)) throw new Tr(c, o);
        var p = s[c];
        if (dt(u))
          (p && "string" != typeof p && "number" != typeof p) ||
            (p = "string" == typeof p || "number" == typeof p ? String(p) : ""),
            a.push({
              type: "string" == typeof p ? Ar.literal : Ar.object,
              value: p,
            });
        else if (ft(u)) {
          var d =
          ...
          if (yt(u)) {
            var m = u.children,
              f = u.value,
              b = s[f];
            if (!Sr(b)) throw new $r(f, "function", o);
            var g = b(
              Br(m, t, r, i, s, n).map(function (e) {
                return e.value;
              })
            );
            Array.isArray(g) || (g = [g]),
              a.push.apply(
                ...
                g.map(function (e) {
                  return {
                    type: "string" == typeof e ? Ar.literal : Ar.object,
                    value: e,
                  };
                })
              );
          ...
          if (gt(u)) {
            if (!(_ = u.options[p] || u.options.other))
              throw new Hr(u.value, p, Object.keys(u.options), o);
            a.push.apply(a, Br(_.value, t, r, i, s));
          } else if (_t(u)) {
            var _;
            ...
            if (!_) throw new Hr(u.value, p, Object.keys(u.options), o);
            a.push.apply(a, Br(_.value, t, r, i, s, p - (u.offset || 0)));
          } else;
        }
      }
    }
    return (function (e) {
      return e.length < 2
        ...
        : e.reduce(function (e, t) {
            var r = e[e.length - 1];
            return (
              r && r.type === Ar.literal && t.type === Ar.literal
                ? (r.value += t.value)
                : e.push(t),
              e
            );
  ...
  var Or = (function () {
          ...
          (this.formatters =
              ...
              (a = { number: {}, dateTime: {}, pluralRules: {} }),
            {
              getNumberFormat: pr(
                ...
                { cache: Lr(a.number), strategy: Er.variadic }
              ),
              getDateTimeFormat: pr(
                ...
                { cache: Lr(a.dateTime), strategy: Er.variadic }
              ),
              getPluralRules: pr(
                function () {
                  for (var e, t = [], r = 0; r < arguments.length; r++)
                ...
                { cache: Lr(a.pluralRules), strategy: Er.variadic }
              ),
            }));
      }
      return (
    ...
    Cr = Or;
  const Nr = { en: qe, nl: st, de: ct };
  function Ir(e, t, ...r) {
    const i = t.replace(/['"]+/g, "");
    let s;
    try {
      s = e.split(".").reduce((e, t) => e[t], Nr[i]);
    } catch (t) {
      s = e.split(".").reduce((e, t) => e[t], Nr.en);
    }
    if (
      (void 0 === s && (s = e.split(".").reduce((e, t) => e[t], Nr.en)),
      !r.length)
    )
      return s;
    const n = {};
    ...
    try {
      return new Cr(s, t).format(n);
    } catch (e) {
      return "Translation " + e;
    }
  }
  let Rr = class extends Ne(he) {
    constructor() {
      super(...arguments),
        (this.probes = []),
        (this.presets = []),
    ...
    async _fetchData() {
      var e;
      this.hass &&
        ((this.config = await Ce(this.hass)),
    ...
    saveToHA(e) {
      var t, r;
      this.hass &&
        (e.probe_source in this.hass.states
          ? ((t = this.hass), (r = e), t.callApi("POST", Ee + "/probes", r))
          : Ie(
              {
                body: {
                  message: Ir(
    ...
    renderTheOptions(e, t) {
      if (this.hass) {
        let r = F`<option value="" ?selected=${void 0 === t}">---${Ir("common.labels.select", this.hass.language)}---</option>`;
        return (
...
<div class="probeline">
  ...
  s([me()], Rr.prototype, "config", void 0),
    s([me({ type: Array })], Rr.prototype, "probes", void 0),
    s([me({ type: Array })], Rr.prototype, "presets", void 0),
    s([me({ type: Array })], Rr.prototype, "state_update_settings", void 0),
    s([me({ type: Array })], Rr.prototype, "sensors", void 0),
    s([fe("#nameInput")], Rr.prototype, "nameInput", void 0),
    s([fe("#sourceInput")], Rr.prototype, "sourceInput", void 0),
    (Rr = s([ce("grill-buddy-view-probes")], Rr));
  const xr = () => {
    const e = (e) => {
        let t = {};
  ...
  (e.GrillBuddyPanel = class extends he {
      ...
      t !== xr().page
        ? (!(function (e, t, r) {
            void 0 === r && (r = !1),
              ...
              ve(window, "location-changed", { replace: r });
          })(
            0,
            ((e, ...t) => {
              let r = { page: e, params: {} };
    ...
    s([me()], e.GrillBuddyPanel.prototype, "hass", void 0),
    s(
    ...
    (e.GrillBuddyPanel = s([ce("grill-buddy")], e.GrillBuddyPanel));
  let Mr = class extends he {
    async showDialog(e) {
  ...
  s([me({ attribute: !1 })], Mr.prototype, "hass", void 0),
    s(
      [
        (function (e) {
          return me({ ...e, state: !0 });
