!(function (e) {
      ...
      : (e) =>
          e instanceof CSSStyleSheet
            ? ((e) => {
                ...
                return ((e) =>
                  new c("string" == typeof e ? e : e + "", void 0, h))(t);
              })(e)
            : e;
  /**
   * @license
  ...
  class A extends HTMLElement {
    ...
    _$EO(e, t, r = y) {
      ...
      if (void 0 !== s && !0 === r.reflect) {
        const n = (
          void 0 !==
          (null === (i = r.converter) || void 0 === i ? void 0 : i.toAttribute)
            ? r.converter
            : v
    ...
    requestUpdate(e, t, r) {
      let i = !0;
      void 0 !== e &&
        (((r = r || this.constructor.getPropertyOptions(e)).hasChanged || _)(
          this[e],
          t
        )
  ...
  (A[E] = !0),
    ...
    null == m || m({ ReactiveElement: A }),
    (null !== (d = f.reactiveElementVersions) && void 0 !== d
      ? d
      : (f.reactiveElementVersions = [])
    ).push("1.6.3");
  const $ = window,
    T = $.trustedTypes,
    S = T ? T.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
    w = "$lit$",
  ...
  const Z = (e, t) => {
    ...
    for (let t = 0; t < r; t++) {
      ...
      let a,
        ...
        l = -1,
        c = 0;
      for (; c < r.length && ((o.lastIndex = c), (h = o.exec(r)), null !== h); )
        (c = o.lastIndex),
          o === x
            ? "!--" === h[1]
              ? (o = M)
            ...
            : o === D
              ? ">" === h[0]
                ...
                : void 0 === h[1]
                  ? (l = -2)
                  : ((l = o.lastIndex - h[2].length),
                    (a = h[1]),
                    (o = void 0 === h[3] ? D : '"' === h[3] ? k : G))
              : o === k || o === G
                ? (o = D)
                : o === M || o === U
                  ? (o = x)
                  : ((o = D), (s = void 0));
      const u = o === D && e[t + 1].startsWith("/>") ? " " : "";
      n +=
        o === x
          ? r + O
          : l >= 0
            ? (i.push(a), r.slice(0, l) + w + r.slice(l) + B + u)
            : r + B + (-2 === l ? (i.push(void 0), t) : u);
    }
  ...
  class Y {
    constructor({ strings: e, _$litType$: t }, r) {
      ...
      for (; null !== (i = z.nextNode()) && a.length < o; ) {
        if (1 === i.nodeType) {
          if (i.hasAttributes()) {
            const e = [];
            for (const t of i.getAttributeNames())
              if (t.endsWith(w) || t.startsWith(B)) {
                const r = l[n++];
                if ((e.push(t), void 0 !== r)) {
                  const e = i.getAttribute(r.toLowerCase() + w).split(B),
                    t = /([.?@])?(.*)/.exec(r);
                  a.push({
                    type: 1,
                    index: s,
          ...
          if (i.data === P) a.push({ type: 2, index: s });
          else {
            let e = -1;
            for (; -1 !== (e = i.data.indexOf(B, e + 1)); )
              a.push({ type: 7, index: s }), (e += B.length - 1);
          }
        s++;
      }
    }
    ...
    return (
      (null == h ? void 0 : h.constructor) !== l &&
        (null === (n = null == h ? void 0 : h._$AO) ||
          void 0 === n ||
          n.call(h, !1),
        void 0 === l ? (h = void 0) : ((h = new l(e)), h._$AT(e, r, i)),
        void 0 !== i
          ? ((null !== (o = (a = r)._$Co) && void 0 !== o ? o : (a._$Co = []))[
              i
            ] = h)
          : (r._$Cl = h)),
      void 0 !== h && (t = q(e, h._$AS(e, t.values), h, i)),
      t
    );
  }
  class J {
      ...
      for (; void 0 !== h; ) {
        if (o === h.index) {
          ...
          2 === h.type
            ...
            : 1 === h.type
              ? (t = new h.ctor(n, h.name, h.strings, this, e))
              : 6 === h.type && (t = new ne(n, this, e)),
            this._$AV.push(t),
            (h = i[++a]);
        }
        o !== (null == h ? void 0 : h.index) && ((n = z.nextNode()), o++);
      }
  ...
  class Q {
      ...
      const { values: r, _$litType$: i } = e,
        s =
          "number" == typeof i
            ? this._$AC(e)
            : (void 0 === i.el &&
                (i.el = Y.createElement(W(i.h, i.h[0]), this.options)),
              i);
    ...
    T(e) {
      ...
      for (const s of e)
        i === t.length
          ? t.push((r = new Q(this.k(L()), this.k(L()), this, this.options)))
          : (r = t[i]),
          r._$AI(s),
          i++;
    ...
    _$AI(e, t = this, r, i) {
      ...
      if (void 0 === s)
        ...
        for (e = s[0], o = 0; o < s.length - 1; o++)
          (a = q(this, i[r + o], t, o)),
            a === V && (a = this._$AH[o]),
            n || (n = !N(a) || a !== this._$AH[o]),
            a === X
              ? (e = X)
              : e !== X && (e += (null != a ? a : "") + s[o + 1]),
            (this._$AH[o] = a);
      }
      n && !i && this.j(e);
    }
  ...
  class se extends ee {
    ...
    _$AI(e, t = this) {
      var r;
      if ((e = null !== (r = q(this, e, t, 0)) && void 0 !== r ? r : X) === V)
        return;
      const i = this._$AH,
        s =
          (e === X && i !== X) ||
  ...
  null == oe || oe(Y, Q),
    (null !== (H = $.litHtmlVersions) && void 0 !== H
      ? H
      : ($.litHtmlVersions = [])
    ).push("2.8.0");
  /**
  ...
  (le.finalized = !0),
    (le._$litElement$ = !0),
    null === (ae = globalThis.litElementHydrateSupport) ||
      void 0 === ae ||
      ae.call(globalThis, { LitElement: le });
  const ce = globalThis.litElementPolyfillSupport;
  null == ce || ce({ LitElement: le }),
    (null !== (he = globalThis.litElementVersions) && void 0 !== he
      ? he
    ...
    return (
      ...
      (r, i) => {
        ...
        }
        {
          ...
          void 0 !== t && Object.defineProperty(r, i, t(i)),
            null == e || e(s, i);
        }
      }
    )({
   ...
   * SPDX-License-Identifier: BSD-3-Clause
   */ var be, me, ve;
  null === (be = window.HTMLSlotElement) ||
    void 0 === be ||
  ...
  const ye = async () => {
    ...
    He = "probe_source",
    $e = "probe_preset",
    Te = "probe_lower_bound",
    Se = "probe_upper_bound",
    we = "probe_state_update_setting",
    Be = "probe_source_type",
    Pe = "source_type_preset",
    Oe = "probe_target_temperature",
    Ce = "metric",
    Le = (e) => e.callWS({ type: Ee + "/config" }),
    Ne = (e) => {
      class t extends e {
        connectedCallback() {
      ...
      return s([fe({ attribute: !1 })], t.prototype, "hass", void 0), t;
    };
  function Ie(e, t) {
    !(function (e, t) {
      const r = e.hasOwnProperty("tagName") ? e : e.target;
      _e(r, "show-dialog", {
...
`;
  let Me = class extends Ne(le) {
    ...
    async _fetchData() {
      this.hass &&
        ((this.config = await Le(this.hass)), (this.data = this.config));
    }
    firstUpdated() {
      (async () => {
        await ye();
    ...
    saveData(e) {
      ...
      this.hass &&
        ...
        ((t = this.hass), (r = this.data), t.callApi("POST", Ee + "/config", r))
          .catch((e) => Ie(e, this.shadowRoot.querySelector("ha-card")))
          .then());
    }
    toggleInformation(e) {
      var t;
  ...
  s([fe()], Me.prototype, "narrow", void 0),
    s([fe()], Me.prototype, "path", void 0),
    s([fe()], Me.prototype, "data", void 0),
    s([fe()], Me.prototype, "config", void 0),
    (Me = s([ue("grill-buddy-view-general")], Me));
  /**
   * @license
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   ...
   */ class Ge extends De {
    constructor(e) {
      if ((super(e), (this.et = X), e.type !== Ue))
        throw Error(
    ...
    render(e) {
      if (e === X || null == e) return (this.ft = void 0), (this.et = e);
      if (e === V) return e;
      if ("string" != typeof e)
        throw Error(
  ...
  var je,
    Fe,
    Ve,
    Xe = { actions: { delete: "Delete" }, labels: { select: "Select" } },
    Ke = {
      probes: {
        title: "Probes",
        ...
        labels: {
          ...
          sourcetypes: { preset: "Preset", value: "Custom value" },
          value: "Target temperature",
        },
        cards: {
          "add-probe": { header: "Add probe", actions: { add: "Add" } },
        },
      },
      help: {
        title: "Help",
    ...
    ze = "Grill Buddy",
    We = { common: Xe, panels: Ke, title: ze },
    Ze = Object.freeze({
      __proto__: null,
      common: Xe,
      panels: Ke,
    ...
    Ye = { actions: { delete: "Verwijderen" }, labels: { select: "Kies" } },
    qe = {
      probes: {
        title: "Thermometers",
        ...
        labels: {
          ...
          sourcetypes: { preset: "Instelling", value: "Eigen waarde" },
          value: "Doeltemperatuur",
        },
        cards: {
          "add-probe": {
            header: "Voeg thermometer toe",
            actions: { add: "Voeg toe" },
          },
        },
      },
      help: {
    ...
    Je = "Grill Buddy",
    Qe = { common: Ye, panels: qe, title: Je },
    et = Object.freeze({
      __proto__: null,
      common: Ye,
      panels: qe,
  ...
  function ct(e) {
    return !(!e || "object" != typeof e || e.type !== Ve.number);
  }
  function ut(e) {
    return !(!e || "object" != typeof e || e.type !== Ve.dateTime);
  }
  !(function (e) {
    ...
    for (var t = {}, r = 0, s = e; r < s.length; r++) {
      ...
      switch (n.stem) {
        ...
        case "integer-width":
          ...
          n.options[0].replace(vt, function (e, r, i, s, n, o) {
      ...
      if (_t.test(n.stem)) t.minimumIntegerDigits = n.stem.length;
      else if (bt.test(n.stem)) {
        if (n.options.length > 1)
          throw new RangeError(
            "Fraction-precision stems only accept a single optional option"
          );
        n.stem.replace(bt, function (e, r, i, s, n, o) {
          return (
            "*" === i
              ...
              : s && "#" === s[0]
                ...
                : n && o
                  ? ((t.minimumFractionDigits = n.length),
                    (t.maximumFractionDigits = n.length + o.length))
                  : ((t.minimumFractionDigits = r.length),
        ...
        "w" === o
          ...
          : o && (t = i(i({}, t), yt(o)));
      } else if (mt.test(n.stem)) t = i(i({}, t), yt(n.stem));
      else {
        var a = Et(n.stem);
        a && (t = i(i({}, t), a));
        var h = At(n.stem);
  ...
  function wt(e) {
    ...
    var r,
      i = e.language;
    return (
      "root" !== i && (r = e.maximize().region),
      (St[r || ""] || St[i || ""] || St["".concat(i, "-001")] || St["001"])[0]
    );
  }
  var Bt = new RegExp("^".concat(pt.source, "*")),
    Pt = new RegExp("".concat(pt.source, "*$"));
  function Ot(e, t) {
    return { start: e, end: t };
  }
  var Ct = !!String.prototype.startsWith && "_a".startsWith("a", 1),
    Lt = !!String.fromCodePoint,
    Nt = !!Object.fromEntries,
    It = !!String.prototype.codePointAt,
    Rt = !!String.prototype.trimStart,
    xt = !!String.prototype.trimEnd,
  ...
  try {
    Ut =
      "a" ===
      (null ===
        (Tt = Kt("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec(
          "a"
        )) || void 0 === Tt
        ? void 0
        : Tt[0]);
  ...
  if (Ut) {
    var zt = Kt("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
    Dt = function (e, t) {
      var r;
      return (
        (zt.lastIndex = t),
        null !== (r = zt.exec(e)[1]) && void 0 !== r ? r : ""
      );
    };
  } else
    Dt = function (e, t) {
  ...
  var Wt = (function () {
    ...
    return (
          ...
          if (123 === s) {
            ...
            if (35 !== s || ("plural" !== t && "selectordinal" !== t)) {
              if (60 === s && !this.ignoreTag && 47 === this.peek()) {
                if (r) break;
                return this.error(
                  je.UNMATCHED_CLOSING_TAG,
                  Ot(this.clonePosition(), this.clonePosition())
                );
              }
              if (60 === s && !this.ignoreTag && Zt(this.peek() || 0)) {
              ...
              this.bump(),
                i.push({
                  type: Fe.pound,
                  location: Ot(o, this.clonePosition()),
                });
            }
          }
        }
        ...
        if ((this.bumpSpace(), this.bumpIf("/>")))
          return {
            val: {
              type: Fe.literal,
              value: "<".concat(i, "/>"),
              location: Ot(r, this.clonePosition()),
            },
            err: null,
          };
        if (this.bumpIf(">")) {
          ...
          if (this.bumpIf("</")) {
            if (this.isEOF() || !Zt(this.char()))
              return this.error(je.INVALID_TAG, Ot(o, this.clonePosition()));
            var a = this.clonePosition();
            return i !== this.parseTagName()
              ? this.error(
                  je.UNMATCHED_CLOSING_TAG,
                  Ot(a, this.clonePosition())
                )
              : (this.bumpSpace(),
                this.bumpIf(">")
                  ? {
                  ...
                  : this.error(je.INVALID_TAG, Ot(o, this.clonePosition())));
          }
          return this.error(je.UNCLOSED_TAG, Ot(r, this.clonePosition()));
        }
        return this.error(je.INVALID_TAG, Ot(r, this.clonePosition()));
      }),
      (e.prototype.parseTagName = function () {
        var e = this.offset();
        for (this.bump(); !this.isEOF() && Yt(this.char()); ) this.bump();
      ...
      (e.prototype.parseLiteral = function (e, t) {
        ...
        var a = Ot(r, this.clonePosition());
        return { val: { type: Fe.literal, value: i, location: a }, err: null };
      }),
      (e.prototype.tryParseLeftAngleBracket = function () {
        return this.isEOF() ||
          60 !== this.char() ||
          (!this.ignoreTag && (Zt((e = this.peek() || 0)) || 47 === e))
          ? null
          : (this.bump(), "<");
        var e;
      }),
      ...
      (e.prototype.parseArgument = function (e, t) {
        ...
        if ((this.bump(), this.bumpSpace(), this.isEOF()))
          return this.error(
            je.EXPECT_ARGUMENT_CLOSING_BRACE,
            Ot(r, this.clonePosition())
          );
        if (125 === this.char())
          return (
            this.bump(),
            this.error(je.EMPTY_ARGUMENT, Ot(r, this.clonePosition()))
          );
        var i = this.parseIdentifierIfPossible().value;
        if (!i)
          return this.error(je.MALFORMED_ARGUMENT, Ot(r, this.clonePosition()));
          ...
          case 44:
            return (
              ...
              this.isEOF()
                ...
                : this.parseArgumentOptions(e, t, i, r)
            );
          default:
            return this.error(
              je.MALFORMED_ARGUMENT,
              Ot(r, this.clonePosition())
            );
        }
      }),
      (e.prototype.parseIdentifierIfPossible = function () {
        var e = this.clonePosition(),
          ...
          i = t + r.length;
        return (
          this.bumpTo(i), { value: r, location: Ot(e, this.clonePosition()) }
        );
      }),
      (e.prototype.parseArgumentOptions = function (e, t, r, s) {
        ...
        switch (a) {
          case "":
            return this.error(je.EXPECT_ARGUMENT_TYPE, Ot(o, h));
          case "number":
          case "date":
          case "time":
            this.bumpSpace();
            ...
            if (this.bumpIf(",")) {
              ...
              if (0 === (f = Xt(v.val)).length)
                return this.error(
                  je.EXPECT_ARGUMENT_STYLE,
                  Ot(this.clonePosition(), this.clonePosition())
                );
              l = { style: f, styleLocation: Ot(c, this.clonePosition()) };
            }
            if ((_ = this.tryParseArgumentClose(s)).err) return _;
            var u = Ot(s, this.clonePosition());
            if (l && Gt(null == l ? void 0 : l.style, "::", 0)) {
              var p = Vt(l.style.slice(2));
              if ("number" === a)
                return (v = this.parseNumberSkeletonFromString(
                  p,
                  l.styleLocation
                )).err
                  ? v
              ...
              if (0 === p.length)
                return this.error(je.EXPECT_DATE_TIME_SKELETON, u);
              var d = p;
              this.locale &&
                (d = (function (e, t) {
              ...
              var f = {
                ...
                parsedOptions: this.shouldParseSkeletons ? ft(d) : {},
              };
              return {
                val: {
            ...
            return {
              val: {
                type:
                  "number" === a ? Fe.number : "date" === a ? Fe.date : Fe.time,
                value: r,
                location: u,
                style:
          ...
          case "select":
            ...
            if ((this.bumpSpace(), !this.bumpIf(",")))
              return this.error(
                je.EXPECT_SELECT_ARGUMENT_OPTIONS,
                Ot(g, i({}, g))
              );
            this.bumpSpace();
            ...
            if ("select" !== a && "offset" === b.value) {
              if (!this.bumpIf(":"))
                return this.error(
                  je.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                  Ot(this.clonePosition(), this.clonePosition())
                );
              var v;
              if (
                ...
                (v = this.tryParseDecimalInteger(
                  je.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,
                  je.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE
                )).err)
              )
                return v;
              this.bumpSpace(),
            ...
            var _,
              y = this.tryParsePluralOrSelectOptions(e, a, t, b);
            if (y.err) return y;
            if ((_ = this.tryParseArgumentClose(s)).err) return _;
            var E = Ot(s, this.clonePosition());
            return "select" === a
              ? {
                  val: {
                    type: Fe.select,
          ...
          default:
            return this.error(je.INVALID_ARGUMENT_TYPE, Ot(o, h));
        }
      }),
        ...
        for (var e = 0, t = this.clonePosition(); !this.isEOF(); ) {
          switch (this.char()) {
            case 39:
              ...
              if (!this.bumpUntil("'"))
                return this.error(
                  je.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,
                  Ot(r, this.clonePosition())
                );
              this.bump();
              break;
      ...
      (e.prototype.parseNumberSkeletonFromString = function (e, t) {
        ...
        try {
          r = (function (e) {
            ...
            for (
              var t = e.split(gt).filter(function (e) {
                  return e.length > 0;
                }),
                r = [],
                i = 0,
      ...
      (e.prototype.tryParsePluralOrSelectOptions = function (e, t, r, i) {
        for (
          var s, n = !1, o = [], a = new Set(), h = i.value, l = i.location;
          ;
          ...
          if (0 === h.length) {
            ...
            var u = this.tryParseDecimalInteger(
              je.EXPECT_PLURAL_ARGUMENT_SELECTOR,
              je.INVALID_PLURAL_ARGUMENT_SELECTOR
            );
            if (u.err) return u;
            (l = Ot(c, this.clonePosition())),
              (h = this.message.slice(c.offset, this.offset()));
          }
          if (a.has(h))
            return this.error(
              "select" === t
                ? je.DUPLICATE_SELECT_ARGUMENT_SELECTOR
                : je.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,
              l
            );
          ...
          if (!this.bumpIf("{"))
            return this.error(
              "select" === t
                ? je.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT
                : je.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,
              Ot(this.clonePosition(), this.clonePosition())
            );
          ...
          if (f.err) return f;
          o.push([h, { value: d.val, location: Ot(p, this.clonePosition()) }]),
            a.add(h),
            this.bumpSpace(),
            (h = (s = this.parseIdentifierIfPossible()).value),
            (l = s.location);
        }
        return 0 === o.length
          ? this.error(
              "select" === t
                ? je.EXPECT_SELECT_ARGUMENT_SELECTOR
                : je.EXPECT_PLURAL_ARGUMENT_SELECTOR,
              Ot(this.clonePosition(), this.clonePosition())
            )
          : this.requiresOtherClause && !n
            ? this.error(
                je.MISSING_OTHER_CLAUSE,
                Ot(this.clonePosition(), this.clonePosition())
              )
            : { val: o, err: null };
      }),
      ...
      (e.prototype.bumpSpace = function () {
        for (; !this.isEOF() && qt(this.char()); ) this.bump();
      }),
    ...
    e.forEach(function (e) {
      if ((delete e.location, ot(e) || at(e)))
        for (var t in e.options)
          delete e.options[t].location, Qt(e.options[t].value);
      else
        (it(e) && ct(e.style)) || ((st(e) || nt(e)) && ut(e.style))
  ...
  function er(e, t) {
    ...
    var r = new Wt(e, t).parse();
    if (r.err) {
      var s = SyntaxError(je[r.err.kind]);
      throw (
        ((s.location = r.err.location), (s.originalMessage = r.err.message), s)
      );
    }
    return (null == t ? void 0 : t.captureLocation) || Qt(r.val), r.val;
  }
  function tr(e, t) {
    var r = t && t.cache ? t.cache : lr,
      i = t && t.serializer ? t.serializer : or;
    return (t && t.strategy ? t.strategy : nr)(e, { cache: r, serializer: i });
  }
  function rr(e, t, r, i) {
    var s,
      n =
  ...
  function mr(e, t, r, i, s, n, o) {
    if (1 === e.length && tt(e[0]))
      return [{ type: ur.literal, value: e[0].value }];
    for (var a = [], h = 0, l = e; h < l.length; h++) {
      var c = l[h];
      if (tt(c)) a.push({ type: ur.literal, value: c.value });
      else if (ht(c))
        "number" == typeof n &&
          a.push({ type: ur.literal, value: r.getNumberFormat(t).format(n) });
      else {
        var u = c.value;
        if (!s || !(u in s)) throw new gr(u, o);
        var p = s[u];
        if (rt(c))
          (p && "string" != typeof p && "number" != typeof p) ||
            (p = "string" == typeof p || "number" == typeof p ? String(p) : ""),
            a.push({
              type: "string" == typeof p ? ur.literal : ur.object,
              value: p,
            });
        else if (st(c)) {
          var d =
          ...
          if (lt(c)) {
            var f = c.children,
              g = c.value,
              b = s[g];
            if (!br(b)) throw new fr(g, "function", o);
            var m = b(
              mr(f, t, r, i, s, n).map(function (e) {
                return e.value;
              })
            );
            Array.isArray(m) || (m = [m]),
              a.push.apply(
                ...
                m.map(function (e) {
                  return {
                    type: "string" == typeof e ? ur.literal : ur.object,
                    value: e,
                  };
                })
              );
          ...
          if (ot(c)) {
            if (!(v = c.options[p] || c.options.other))
              throw new dr(c.value, p, Object.keys(c.options), o);
            a.push.apply(a, mr(v.value, t, r, i, s));
          } else if (at(c)) {
            var v;
            ...
            if (!v) throw new dr(c.value, p, Object.keys(c.options), o);
            a.push.apply(a, mr(v.value, t, r, i, s, p - (c.offset || 0)));
          } else;
        }
      }
    }
    return (function (e) {
      return e.length < 2
        ...
        : e.reduce(function (e, t) {
            var r = e[e.length - 1];
            return (
              r && r.type === ur.literal && t.type === ur.literal
                ? (r.value += t.value)
                : e.push(t),
              e
            );
  ...
  var yr = (function () {
      function e(t, r, s, o) {
        ...
        if (
          ...
          (this.resolvedOptions = function () {
            ...
            return {
              locale:
                (null === (e = h.resolvedLocale) || void 0 === e
                  ? void 0
                  : e.toString()) ||
          ...
          this.ast = e.__parse(t, i(i({}, c), { locale: this.resolvedLocale }));
        } else this.ast = t;
        if (!Array.isArray(this.ast))
          throw new TypeError("A message must be provided as a String or AST.");
        (this.formats = vr(e.formats, s)),
          (this.formatters =
            (o && o.formatters) ||
              ...
              (a = { number: {}, dateTime: {}, pluralRules: {} }),
            {
              getNumberFormat: tr(
                ...
                { cache: _r(a.number), strategy: cr.variadic }
              ),
              getDateTimeFormat: tr(
                ...
                { cache: _r(a.dateTime), strategy: cr.variadic }
              ),
              getPluralRules: tr(
                function () {
                  for (var e, t = [], r = 0; r < arguments.length; r++)
                ...
                { cache: _r(a.pluralRules), strategy: cr.variadic }
              ),
            }));
      }
      return (
    ...
    Er = yr;
  const Ar = { en: Ze, nl: et };
  function Hr(e, t, ...r) {
    const i = t.replace(/['"]+/g, "");
    let s;
    try {
      s = e.split(".").reduce((e, t) => e[t], Ar[i]);
    } catch (t) {
      s = e.split(".").reduce((e, t) => e[t], Ar.en);
    }
    if (
      (void 0 === s && (s = e.split(".").reduce((e, t) => e[t], Ar.en)),
      !r.length)
    )
      return s;
    const n = {};
    for (let e = 0; e < r.length; e += 2) {
      let t = r[e];
      (t = t.replace(/^{([^}]+)?}$/, "$1")), (n[t] = r[e + 1]);
    }
    try {
      return new Er(s, t).format(n);
    } catch (e) {
      return "Translation " + e;
    }
  }
  let $r = class extends Ne(le) {
    constructor() {
      super(...arguments),
        (this.probes = []),
        (this.presets = []),
        (this.state_update_settings = []),
        (this.sensors = []);
    }
    firstUpdated() {
      (async () => {
    ...
    async _fetchData() {
      var e;
      this.hass &&
        ((this.config = await Le(this.hass)),
        (this.probes = await ((e = this.hass),
        e.callWS({ type: Ee + "/probes" }))),
        (this.presets = await ((e) => e.callWS({ type: Ee + "/presets" }))(
          this.hass
        )),
        (this.state_update_settings = await ((e) =>
          e.callWS({ type: Ee + "/stateupdatesettings" }))(this.hass)),
        (this.sensors = await ((e) => e.callWS({ type: Ee + "/sensor" }))(
          this.hass
        )));
    }
    handleAddProbe() {
      const e = {
        ...
        probe_source_type: Pe,
        probe_preset: void 0,
      };
      (this.probes = [...this.probes, e]), this.saveToHA(e);
    }
    handleEditProbe(e, t) {
      this.hass &&
        ((this.probes = Object.values(this.probes).map((r, i) =>
          i === e ? t : r
        )),
        this.saveToHA(t));
    }
    handleRemoveProbe(e, t) {
      ...
      var i, s;
      r &&
        ((this.probes = this.probes.filter((e, r) => r !== t)),
        this.hass &&
          ((i = this.hass),
          (s = r.probe_id.toString()),
          i.callApi("POST", Ee + "/probes", { probe_id: s, remove: !0 })));
    }
    saveToHA(e) {
      var t, r;
      this.hass &&
        ...
        (r = e),
        console.log(r),
        t.callApi("POST", Ee + "/probes", r));
    }
    renderTheOptions(e, t) {
      if (this.hass) {
        let r = F`<option value="" ?selected=${void 0 === t}">---${Hr("common.labels.select", this.hass.language)}---</option>`;
        return (
    ...
    renderProbe(e, t) {
      if (this.hass) {
        let r = F``;
        const i = e.probe_source_type === Pe;
        return (
          (r = i
            ? F`
          <div class="probeline">
...
<div class="probeline">
  ...
  s([fe()], $r.prototype, "config", void 0),
    s([fe({ type: Array })], $r.prototype, "probes", void 0),
    s([fe({ type: Array })], $r.prototype, "presets", void 0),
    s([fe({ type: Array })], $r.prototype, "state_update_settings", void 0),
    s([fe({ type: Array })], $r.prototype, "sensors", void 0),
    s([ge("#nameInput")], $r.prototype, "nameInput", void 0),
    s([ge("#sourceInput")], $r.prototype, "sourceInput", void 0),
    ($r = s([ue("grill-buddy-view-probes")], $r));
  const Tr = () => {
    const e = (e) => {
        let t = {};
        for (let r = 0; r < e.length; r += 2) {
          ...
          t = Object.assign(Object.assign({}, t), { [i]: s });
        }
        return t;
      },
      t = window.location.pathname.split("/");
    let r = { page: t[2] || "probes", params: {} };
    if (t.length > 3) {
      let i = t.slice(3);
      if (t.includes("filter")) {
        const t = i.findIndex((e) => "filter" == e),
          s = i.slice(t + 1);
        (i = i.slice(0, t)),
          (r = Object.assign(Object.assign({}, r), { filter: e(s) }));
      }
      i.length &&
        (i.length % 2 &&
          (r = Object.assign(Object.assign({}, r), { subpage: i.shift() })),
        i.length &&
          (r = Object.assign(Object.assign({}, r), { params: e(i) })));
    }
    return r;
  };
  (e.GrillBuddyPanel = class extends le {
    async firstUpdated() {
      window.addEventListener("location-changed", () => {
        window.location.pathname.includes("grill-buddy") &&
          this.requestUpdate();
      }),
        await ye(),
        this.requestUpdate();
    ...
    render() {
      if (!customElements.get("ha-panel-config")) return F` loading... `;
      const e = Tr();
      return F`
      <div class="header">
        <div class="toolbar">
      ...
      t !== Tr().page
        ? (!(function (e, t, r) {
            void 0 === r && (r = !1),
              ...
              _e(window, "location-changed", { replace: r });
          })(
            0,
            ((e, ...t) => {
              let r = { page: e, params: {} };
              t.forEach((e) => {
                "string" == typeof e
                  ? (r = Object.assign(Object.assign({}, r), { subpage: e }))
                  : "params" in e
              ...
              let s = `/${Ee}/${r.page}`;
              return (
                r.subpage && (s = `${s}/${r.subpage}`),
                i(r.params).length && (s = `${s}/${i(r.params)}`),
                r.filter && (s = `${s}/filter/${i(r.filter)}`),
                s
              );
            })(t)
          ),
    ...
    s([fe()], e.GrillBuddyPanel.prototype, "hass", void 0),
    s(
      [fe({ type: Boolean, reflect: !0 })],
      e.GrillBuddyPanel.prototype,
      "narrow",
      void 0
    ),
    (e.GrillBuddyPanel = s([ue("grill-buddy")], e.GrillBuddyPanel));
  ...
  s([fe({ attribute: !1 })], Sr.prototype, "hass", void 0),
    s(
      [
        (function (e) {
          return fe({ ...e, state: !0 });
